...
// context.
//
// Import constraint: this package depends only on the Go standard library. It
// is imported both by tenant-scoped application/adapter code and by
// cross-cutting infrastructure (e.g. internal/observability), so it must stay
